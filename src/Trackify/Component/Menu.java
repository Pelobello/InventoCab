...
import Trackify.Swing.ButtonCustom;
import Trackify.Swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
 public void setEvent(EventMenuSelected event) {
    ...
    private void createButtonMenu(){
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/Trackify/Icons/menuBurger.png")));
        cmdMenu.setBorder(new EmptyBorder(1,1,1,7));
       
    }
    private void createButtonLogout() {
        cmdLogOut = new ButtonCustom();
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/Trackify/Icons/exit.png")));
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        GradientPaint gra =new GradientPaint(0, 0, Color.decode("#FFFFFF"), 0, getHeight(), Color.decode("#FFFFFF"));
        g2.setPaint(gra);
